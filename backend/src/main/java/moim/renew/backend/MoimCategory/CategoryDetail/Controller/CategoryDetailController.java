package moim.renew.backend.MoimCategory.CategoryDetail.Controller;
...
import moim.renew.backend.MoimCategory.CategoryDetail.Service.MoimCategoryDetaillService;
...
public class CategoryDetailController
{
    ...
    @PostMapping
    public ResponseEntity<?> Insert(@AuthenticationPrincipal String userId, @RequestBody MoimCategoryDetailDTO moimCategoryDetailDTO)
    {
        try
        {
    ...
    @GetMapping
    public ResponseEntity<?> Getting(@AuthenticationPrincipal String userId, @RequestBody Integer MoimCategoryId)
    {
        try
        {
            if (userId == null || userId.isEmpty()) {
            ...
            List<MoimCategoryDetailDTO> moimCategoryDetailDTOS = moimCategoryDetaillService.SelectAll(MoimCategoryId);
    ...
    @DeleteMapping
    public ResponseEntity<?> Delete(@AuthenticationPrincipal String userId, @RequestBody String MoimCategoryDetailId)
    {
        try
        {
            if (userId == null || userId.isEmpty()) {
            ...
            if(userDTO.getType() == UserTypeEnum.MANAGER)
            {
                Boolean bool = moimCategoryDetaillService.Delete(MoimCategoryDetailId);
                if(bool)
                {
